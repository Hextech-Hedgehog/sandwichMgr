...
class PersonServiceImplTest {
    ...
    public void findPersonAlbusTest() throws PersonNotFoundException {
        assertEquals("Albus", personService.findUserByName("Albus").getFirstName());
    }

    @Test
    public void findPersonHarryTest() throws PersonNotFoundException {
        assertEquals("Harry", personService.findUserByName("Harry").getFirstName());
    }

    @Test
    public void findPersonArchibaldTest() throws PersonNotFoundException {
        assertEquals("Archibald", personService.findUserByName("Archibald").getFirstName());
    }

    @Test
    public void findCourseThrowsCourseNotFoundExceptionTest() throws PersonNotFoundException {
        assertThrows(CourseNotFoundException.class, () -> personService.findUserByName(null));
    }
